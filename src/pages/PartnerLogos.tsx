...
const PartnerSlider = () => {
  ...
  const partners = [
    { id: 1, name: 'PDO', logo: 'https://www.hint-global.com/wp-content/uploads/2022/03/PDO-Transparent.png', color: 'hover:border-blue-500' },
    { id: 2, name: 'Oman Oil', logo: 'https://media.majarracdn.cloud/manhom/mgmt/images/77725/1730119706/%D8%B4%D8%B1%D9%83%D8%A9-%D8%A7%D9%84%D9%86%D9%81%D8%B7-%D8%A7%D9%84%D8%B9%D9%85%D8%A7%D9%86%D9%8A%D8%A9-%D9%84%D9%84%D8%AA%D8%B3%D9%88%D9%8A%D9%82.jpg', color: 'hover:border-emerald-500' },
    { id: 3, name: 'Shell', logo: 'https://upload.wikimedia.org/wikipedia/en/thumb/e/e8/Shell_logo.svg/250px-Shell_logo.svg.png', color: 'hover:border-amber-500' },
    { id: 4, name: 'asianpaints', logo: 'https://printwavesoman.com/wp-content/uploads/2024/10/cl-4.webp', color: 'hover:border-purple-500' },
    { id: 5, name: 'Monanoor', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0RA9sPr4oZf4y1v1fwteCJ32MZ2Nrvm9YSQ&s', color: 'hover:border-cyan-500' },
    { id: 6, name: 'Quantum', logo: 'https://printwavesoman.com/wp-content/uploads/2024/10/cl-1.webp', color: 'hover:border-rose-500' },
  ];
    ...
    <div className="w-full bg-slate-50 py-20 px-4 font-sans">
      <div className="max-w-6xl mx-auto text-center mb-16">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto text-lg">
          We provide specialized solutions tailored to your unique real estate needs.
        </p>
      </div>
      ...
      <div className="relative group overflow-hidden py-10">
        ...
        <div className="flex w-fit animate-infinite-scroll group-hover:pause-animation">
          {displayPartners.map((partner, index) => (
            ...
            >
              <div className={`relative group/item bg-white p-6 md:p-10 h-32 md:h-40 rounded-2xl shadow-sm border border-slate-100 ${partner.color} hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer w-full flex items-center justify-center overflow-hidden`}>
