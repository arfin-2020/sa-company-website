    ...
    <section className="py-20 bg-brand-dark text-white">
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/5 p-10 rounded-lg border border-white/10 reveal transition-all hover:border-brand-accent">
                    <div className="w-12 h-12 bg-brand-accent rounded-full flex items-center justify-center mb-6">
                    ...
                    <ul className="space-y-3 text-gray-400">
                        <li className="flex items-center"><span className="text-brand-accent mr-2">▹</span> High quality standards in all phases</li>
                        <li className="flex items-center"><span className="text-brand-accent mr-2">▹</span> Optimal cost efficiency for clients</li>
                        <li className="flex items-center"><span className="text-brand-accent mr-2">▹</span> Implementation of innovative technology</li>
                        <li className="flex items-center"><span className="text-brand-accent mr-2">▹</span> Strong project management protocols</li>
                    </ul>
                </div>
                <div className="bg-white/5 p-10 rounded-lg border border-white/10 reveal transition-all hover:border-brand-accent" style={{ transitionDelay: "200ms" }}>
                    <div className="w-12 h-12 bg-brand-accent rounded-full flex items-center justify-center mb-6">
